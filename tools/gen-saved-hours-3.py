#!/usr/bin/env python3
"""saved-hours-3: re-shoot of saved-hours. Same words, new photos.

Copied from gen-saved-hours-2.py; only TOPIC and BGS differ.
...
identically. One thing was taken out of the picker's hands: the twelve
photographs saved-hours and saved-hours-2 shot on are excluded from the walk,
because a re-shoot that reuses the source's own photos is not a re-shoot.

  01 hook        bg-h12  desk-person-night  the one person
  02 Perplexity  bg-h21  lounge-night       copy_band_luma 64.6
  03 ARCO        bg-h22  lounge-day         copy_band_luma 53.5
  04 Make        bg-h36  supercars-dusk     copy_band_luma 20.3
  05 Photoroom   bg-h49  desk-city-day      copy_band_luma 54.8
  06 ElevenLabs  bg-h88  supercars-dusk     copy_band_luma 28.2
...
BGS = ['bg-h12.jpg', 'bg-h21.jpg', 'bg-h22.jpg', 'bg-h36.jpg',
       'bg-h49.jpg', 'bg-h88.jpg']
