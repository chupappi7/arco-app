#!/usr/bin/env python3
"""wish-i-knew-at-17-7: five apps a 17 year old would actually get use out of.
...
Usage:
    ...
    python3 tools/gen-wish-i-knew-at-17-7.py --only 03  # one slide, for redos
"""
import json
import os
import sys
...
BGS = ['bg-h79.jpg',   # 01 hook        desk-led-neon
       ...
       'bg-h88.jpg',   # 05 Obsidian    supercars-dusk     band luma 28.2
       'bg-n01.jpg']   # 06 Canva       villa-day          band luma 66.3
